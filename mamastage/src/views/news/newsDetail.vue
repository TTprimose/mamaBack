    ...
    <div>
        ...
        <div class="model_content" >
            <div class="content" :style="{height: $store.state.home.modelContentHeight - 20 + 'px'}" style="background:white;overflow:auto" >
                <div class="textTitle">
                    <h3>{{newsDeadilForm.title}}</h3>
                    <div class="titleSmall">
                        <p>来源：{{newsDeadilForm.source}}</p>
                        <p>发布时间：{{newsDeadilForm.releaseTime | time_s}}</p>
                    </div>
                </div>
                ...
                <div class="caseContent">
                    <img :src="newsDeadilForm.picUrl" alt="">
                </div>
            </div>
        </div>
...
export default {
    ...
    methods:{
        ...
        clearAll() {
            for (let key in this.newsDeadilForm) {
                this.newsDeadilForm[key] = null
            }
        }
    },
    created(){},
    ...
    activated() {
        ...
        api.getnewsid(this.newsId).then((response) => {
            ...
            this.newsDeadilForm = response.data

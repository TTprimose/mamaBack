                ...
                <el-form ref="myForm" class="myForm" :inline="true" :model="addFormData" :rules="rules" label-position="right" label-width="140px">
                    <div class="baseInfoBox">
                        <el-form-item label="栏目：">
                            <span style="font-size: 14px;font-weight: bold">荣誉资质</span>
                        </el-form-item>
                    </div>
                    <!--<div class="baseInfoBox showhide">-->
                    ...
                    <div class="baseInfoBox">
                        <el-form-item label="内容：">
                            <div id='editorE_future' style="max-height:1000px;width: 850px"></div>
                        </el-form-item>
                    </div>
                    <div class="baseInfoBox">
...
export default {
    ...
    methods: {
        createEditor() {
            this.editor = new E('#editorE_future')
        ...
        handleAvatarSuccess(res, file, fileList) {
            ...
            if (this.fileList.length == 1){
                $('.showhide .el-upload--picture-card').css('display', 'none')
            }
        },
        // 移除图片
        handleRemove(file, fileList) {
            this.fileList = fileList
            if (this.fileList.length < 1){
                $('.showhide .el-upload--picture-card').css('display', 'inline-block')
            }
        },
        ...
        save() {
            ...
            api.editFuture(this.postData).then((res) => {
                if (res.result == 1) {
                    this.$message({
                        type: 'success',
                        message: '修改成功！'

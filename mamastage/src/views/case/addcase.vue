                ...
                <el-form ref="myForm" class="myForm" :inline="true" :model="addFormData" :rules="rules" label-position="right" size="small" label-width="140px">
                    ...
                    <div class="baseInfoBox" >
                        <el-form-item label="视频">
                            ...
                            <!-- <div id='video'>
                                <input type="file" id="file_upload" name="file_upload" capture="camcorder" accept="video/*" @change="tirggerFile($event)">
                                上传视频
                            </div>
                            <el-button type="primary" size="small">添加视频至内容</el-button> -->
...
export default {
    ...
    methods:{
        ...
        //         this.addFormData.video = res.data.data.url
        //         console.log(this.addFormData.video)
        //     })
            ...
            this.$refs['myForm'].validate((valid) => {
                if (valid) {
                    ...
                    if (typeof(this.caseId) != 'undefined'){
                        ...
                        api.putcaseupdate(this.addFormData).then(() => {
                            this.$message({
                                message: '修改成功',
                                type: 'success'
                            });
                        ...
                        api.postcaseadd(this.addFormData).then((res) => {
                            this.$message({
                                message: '新增成功',
                                type: 'success'
                            });
